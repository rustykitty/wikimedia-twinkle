...
Twinkle.rollback.callbacks = {
	...
	main: function(apiobj) {
		...
		if (((Twinkle.getPref('confirmOnFluff') || Twinkle.getPref('confirmOnRollback')) ||
			// Mobile user agent taken from [[en:MediaWiki:Gadget-confirmationRollback-mobile.js]]
			((Twinkle.getPref('confirmOnMobileFluff') || Twinkle.getPref('confirmOnRollback')) && /Android|webOS|iPhone|iPad|iPod|BlackBerry|Mobile|Opera Mini/i.test(navigator.userAgent))) &&
